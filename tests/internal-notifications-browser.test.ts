...
function notification(overrides: Partial<InternalNotificationDto> = {}): InternalNotificationDto {
  return {
    ...
    downloadHref: "/api/certificados/11111111-1111-4111-8111-111111111111/arquivo",
    windowsDownloadHref: "/api/internal-notifications/windows/11111111-1111-4111-8111-111111111111/certificate-file",
    downloadLabel: "Baixar certificado",
